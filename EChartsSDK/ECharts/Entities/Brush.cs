...
namespace ECharts.Entities
{
    ...
    {
        public IList<BrushToolBoxType> toolbox { get; set; }
        ...
        public BrushThrottleType? throttleType { get; set; }

        public int? throttleDelay { get; set; }

        public bool? removeOnClick { get; set; }

        public VisualItem inBrush { get; set; }

        public VisualItem outBrush { get; set; }
